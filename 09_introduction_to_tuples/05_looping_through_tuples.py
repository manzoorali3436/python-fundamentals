...
Definition:
Looping through a tuple means visiting each item
...
print("Use a for loop to visit every item in a tuple.")
print("Use a while loop when you need an index.")
print("range(len(tuple)) gives both the index and the item.")
print("Use break to stop a loop early.")
print("Use continue to skip an item.")
print("Tuples are iterable but immutable.")